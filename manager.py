...
def add_plots(attacker, defender, which):
...
# add_plots(DQNWrapper.load('weights/attacker_63be0de9_weights.pkl'), UniformDefender(), 1)
# add_plots(UniformAttacker(), UniformDefender(), 0)
